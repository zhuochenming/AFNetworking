...
@interface UUNetworkSession ()

@property (readwrite, nonatomic, strong) NSURL *baseURL;

@end

@implementation UUNetworkSession
...
- (NSURLSessionDataTask *)POST:(NSString *)URLString
     ...
     constructingBodyWithBlock:(nullable void (^)(id<AFMultipartFormData> _Nonnull))block
                       ...
                       failure:(nullable void (^)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull, id _Nullable responseObject))failure {
...
- (instancetype)copyWithZone:(NSZone *)zone {
    UUNetworkSession *HTTPClient = [[[self class] allocWithZone:zone] initWithBaseURL:self.baseURL sessionConfiguration:self.session.configuration];
